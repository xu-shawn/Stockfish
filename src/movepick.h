...
// CapturePieceToHistory is addressed by a move's [piece][to][captured piece type][SEE]
using CapturePieceToHistory = Stats<int16_t, 10692, PIECE_NB, SQUARE_NB, PIECE_TYPE_NB, 2>;
