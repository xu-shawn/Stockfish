...
struct TTEntry {
    ...
    void update_generation(uint8_t generation8);
...
void TTEntry::update_generation(uint8_t generation8) {
    genBound8 = uint8_t(generation8) | (genBound8 & GENERATION_DELTA);
}
...
void TTWriter::update_age(uint8_t generation8) { entry->update_generation(generation8); }
