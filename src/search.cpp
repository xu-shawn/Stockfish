...
Value to_corrected_static_eval(Value v, const Worker& w, const Position& pos) {
    auto pcv = w.pawnCorrectionHistory[pos.side_to_move()][pawn_structure_index<Correction>(pos)];
    auto mcv = w.materialCorrectionHistory[pos.side_to_move()][material_index(pos)];
    auto cv  = (pcv + mcv) / 2;
    v += 66 * cv / 512;
